...
export const LLM_CONFIG: Record<LlmProviderKey, LlmProviderCfg> = {
  deepseek: { provider: "openai-compatible", model: "deepseek-chat", baseURL: "https://api.deepseek.com/v1", envKey: "DEEPSEEK_API_KEY", enabled: true, maxTokens: 8192, maxTokensRange: { min: 1, max: 8192, default: 4096 }, notes: "主用" },
